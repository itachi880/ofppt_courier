  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="p-4 w-full max-w-4xl bg-white shadow-md rounded-md">
        <h1 className="text-xl font-semibold text-gray-800 mb-3 text-center">Departments</h1>
        {loading ? (
          ...
          <table className="w-full table-auto border-separate border-spacing-0.5">
            <thead>
              <tr>
                ...
                <th className="text-sm text-gray-600 font-medium py-2 px-3 border-b">Created At</th>
            ...
            <tbody>
              {departments.map((e) => (
                <tr key={e.id} className="hover:bg-gray-100">
                  <td className="text-sm text-gray-700 py-2 px-3 border-b">{e.department_name}</td>
                  <td className="text-sm text-gray-700 py-2 px-3 border-b">{e.department_created_at}</td>
